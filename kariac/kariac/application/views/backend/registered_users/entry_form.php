      		...
      		<div class="card-body">
        		<div class="row">
					<div class="col-md-3">
						...
						<div class="form-group">	
							<label><?php echo get_msg('apple_verify').":"; ?></label><br>
						</div>
						<div class="form-group">	
					...
					<div class="col-md-3">
						...
						<div class="form-group">
							<label><?php if ($user->email_verify == "1" && $user->status == "1") {
								echo "Yes";
							} else if ($user->email_verify == "1" && $user->status != "1") {
								echo "Pending";
							} else{
								echo "No";
							} ?>
						...
						<div class="form-group">
							<label><?php if ($user->apple_verify == "1") {
									echo "Yes";
							} else{
