	...
	function upload_item_post()
	{
		...
		$img_id = $this->post('img_id');
			...
			if ($img_id == "") {
				...
				if($path_parts['extension'] != "jpg" or $path_parts['extension'] != "JPG" or $path_parts['extension'] != "png" or $path_parts['extension'] != "PNG" or $path_parts['extension'] != "jpeg" or $path_parts['extension'] != "JPEG") {
