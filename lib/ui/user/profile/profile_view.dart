...
// class RejectedDataWidget extends StatefulWidget {
//   const RejectedDataWidget(
//       {Key key,
//       @required this.animationController,
//       this.userId,
//       this.animation})
...
//   @override
//   _RejectedDataWidgetState createState() => _RejectedDataWidgetState();
// }

// class _RejectedDataWidgetState extends State<RejectedDataWidget> {
//   ProductRepository productRepository;
//   PsValueHolder psValueHolder;
...
//               if (provider.psValueHolder.loginUserId == null ||
//                   provider.psValueHolder.loginUserId == '') {
//                 provider.addedUserParameterHolder.status = '0';
//                 provider.loadItemList(
//                     widget.userId, provider.addedUserParameterHolder);
//               } else {
//                 // provider.addedUserParameterHolder.addedUserId =
