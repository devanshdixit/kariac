...
class PsColors {
  ...
  static const Color _c_main_color = Color(0xFFA92428);
  static const Color _c_main_light_color = Color(0xFFFFE5E6); //FFF0F1);
  static const Color _c_main_dark_color = Color(0xFF80070B);
